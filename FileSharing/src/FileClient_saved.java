	...
	public class HandleClientRequests implements Runnable {
		...
		public void run() {
			...
			try{
				...
				System.out.println(" ");
				System.out.println(" ");
				System.out.println("Where do you want to store your downloaded files on the Client?");
				System.out.println("Enter the Client directory name, including the path and the final /");
				System.out.println("Example - /usr/local/shared/SWE622/ckoerner/CLIENT/DOWNLOADED/");
				System.out.println("The directory must already exist.");
				System.out.println(" ");
				Scanner keyboard = new Scanner(System.in);
				String down_directory = keyboard.nextLine();
				
				System.out.println(" ");
				System.out.println(" ");
				System.out.println("Where do you want to store the uploaded files on the Server?");
				System.out.println("Enter the Server directory name, including the path and the final /");
				System.out.println("Example - /usr/local/shared/SWE622/ckoerner/SERVER/UPLOADED/");
				System.out.println("The directory must already exist.");
				System.out.println(" ");
				keyboard = new Scanner(System.in);
				String up_directory = keyboard.nextLine();
				
				outToServer.writeObject(up_directory);
				outToServer.flush();
				...
				while(true){
					...
					if(answer.equals("X")){
						...
						try{
							...
							System.out.println("Need to restart Client and Server");
							break;
						} catch (Exception ex){
							ex.printStackTrace();
						}
					...
					if(answer.equals("D")){
						...
						try{
							...
							receiveFile(inFromServer, outToServer, downloadedFile, down_directory);
		...
		public void receiveFile(ObjectInputStream is, ObjectOutputStream os, 
				String downloadedFile, String down_directory) throws Exception{
